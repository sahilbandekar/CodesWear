    ...
    <section className="text-gray-600 body-font overflow-hidden">
      <div className="container px-5 py-16 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto px-16 object-cover object-center rounded" src={product.img} />
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex">
              ...
              <button onClick={() => { buyNow(slug, 1, 499, product.title, size, color) }} className="flex ml-8 text-white bg-pink-500 border-0 py-2 px-1 md:px-6 focus:outline-none hover:bg-pink-600 rounded">&nbsp;Buy Now&nbsp;</button>
              <button onClick={() => { addToCart(slug, 1, 499, product.title, size, color) }} className="flex ml-4 text-white bg-pink-500 border-0 py-2 px-1 md:px-6 focus:outline-none hover:bg-pink-600 rounded">&nbsp;Add to Cart&nbsp;</button>
            ...
            <div className="pin mt-5 flex space-x-2 text-sm">
              <input onChange={onChangePin} maxLength={6} type="text" className="px-2 border-2 border-gray-400 rounded-md" />
